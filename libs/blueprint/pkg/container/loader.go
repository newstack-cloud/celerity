...
// and the blueprint schema with all the metadata labels, annotations and selectors.
// This save us from having to rebuild the entire spec with the concrete
// types of the resource specs generated by providers.
// This is structure of the spec encapsulated by the blueprint container.
type internalBlueprintSpec struct {
	resources map[string]speccore.ResourceSchemaSpec[interface{}]
	schema    *schema.Blueprint
}

func (s *internalBlueprintSpec) ResourceConcreteSpec(resourceName string) interface{} {
...
func (l *defaultLoader) loadSpec(
	...
	return &internalBlueprintSpec{
		...
		resources: internalResourceSpecs,
	}, nil
}
...
func (l *defaultLoader) validateResources(
	...
	for name, resourceSchema := range blueprintSchema.Resources {
		...
		if err != nil {
			...
			internalResourceSpecs[name] = speccore.ResourceSchemaSpec[interface{}]{
...
func (l *defaultLoader) deriveProviderResource(resourceType string) (provider.Resource[interface{}], error) {
