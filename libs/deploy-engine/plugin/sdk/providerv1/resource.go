...
import (
	...
	"github.com/two-hundred/celerity/libs/deploy-engine/plugin/sdk/schema"
)
...
type ResourceDefinition struct {
	...
	// A static list of resoruce types, that when dependencies of this resource type
	// must be stabilised before this resource can be deployed.
