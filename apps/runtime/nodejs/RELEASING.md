...
4. The release workflow builds and pushes Docker images to GHCR:
   - Production: `ghcr.io/newstack-cloud/celerity-runtime-nodejs-24:0.4.0`, `:0.4`, `:latest`
   - Dev: `ghcr.io/newstack-cloud/celerity-runtime-nodejs-24:dev-0.4.0`, `:dev-latest`
