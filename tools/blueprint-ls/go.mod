module github.com/newstack-cloud/celerity/tools/blueprint-ls

go 1.23.4

replace github.com/newstack-cloud/celerity/libs/blueprint => ../../libs/blueprint
...
require (
	...
	github.com/newstack-cloud/ls-builder v0.2.3
